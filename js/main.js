...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoiZWhhYmVsc2VzZSIsImEiOiJjazAyNG14c3QyMWdzM21wazJvdnUxMGdhIn0.tHgMN0L15pfC_fyRKC5IBQZUI9A',
    maxZoom: 18,
 ...
 * The .then() promise function is used to chain a success 
 * */
